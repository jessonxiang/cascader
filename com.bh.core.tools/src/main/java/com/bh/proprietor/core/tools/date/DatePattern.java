...
public class DatePattern {
	...
	/** 中文年月日格式*/
	public final static String SIMPLE_DATE_CHINESE_PATTERN = "yyyy年MM月dd日";
	/** 简短时间格式 {@link FastDateFormat} */
	public final static FastDateFormat SIMPLE_DATE_FORMAT = FastDateFormat.getInstance(SIMPLE_DATE_PATTERN);
