package com.bh.proprietor.core.tools.date.format;
...
public interface DateParser extends DateBasic {
	 ...
	 * ParsePosition index is updated to indicate how much of the source text
	 * was consumed. Not all source text needs to be consumed. Upon parse
	 * failure, ParsePosition error index is updated to the offset of the source
	 * text which does not match the supplied format.
	 *
	 * @param source
	 *            被转换的日期字符串
	 * @param pos
	 *            定义开始转换的位置，转换结束后更新转换到的位置
	 * @param calendar
