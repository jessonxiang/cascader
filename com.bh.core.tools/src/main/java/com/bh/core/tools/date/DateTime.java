...
public class DateTime extends Date {
	...
	private static Date parse(String dateStr, DateParser parser) {
		try {
			...
			throw new DateException(StrUtil.format("Parse [{}] with format [{}] error!", dateStr, parser.getPattern()),
					e);
		}
	}
}
