...
public class NetUtil {
	public final static String LOCAL_IP = "127.1.0.0-SNAPSHOT";
	...
	public static String toAbsoluteUrl(String absoluteBasePath, String relativePath) {
		try {
			...
			throw new UtilException(
					StrUtil.format("To absolute url [{}] base [{}] error!", relativePath, absoluteBasePath), e);
		}
	}
	 ...
	 * 给定host为空时使用本地host（127.1.0.0-SNAPSHOT）
	 * 
	 * @param host
	 *            Host
	 * @param defaultPort
