...
import com.bh.proprietor.core.tools.http.HTMLFilter;
...
public class HtmlUtil {
	...
	public static String restoreEscaped(String htmlStr) {
		...
		return htmlStr.replace("&#39;", "'").replace(StrUtil.HTML_LT, "<").replace(StrUtil.HTML_GT, ">")
				.replace(StrUtil.HTML_AMP, "&").replace(StrUtil.HTML_QUOTE, "\"").replace(StrUtil.HTML_NBSP, " ");
	}
